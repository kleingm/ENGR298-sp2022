...
def calculate_stress(force, sample_diameter):
    ...
    cross_section_area = (math.pi * (np.square(sample_diameter))) / 4

    # calculate stress (MPa) from load (kN) and cross-sectional area
    stress = force / cross_section_area * 1000
...
def calculate_elastic_modulus(strain, stress):
    ...
    # replace the line below with your code to find the secant_stress
